...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-base-100 text-base-content">
      <div>
        <span className="footer-title text-red-500">Services</span>
      ...
      <div>
        <span className="footer-title text-red-500">Company</span>
      ...
      <div>
        <span className="footer-title text-red-500">Social</span>
